  ...
  return (
    <div className="h-screen flex justify-center items-center bg-gray-50">
      <main className="flex flex-col gap-8 items-start">
        ...
        <div
          className={`max-w-[45ch] rounded-lg px-8 py-6 bg-white border border-gray-200 text-lg flex flex-col gap-4`}
        >
          <h1 className="uppercase text-gray-500 text-sm">Passage</h1>
          <p className={`${font} text-lg`}>{text}</p>
        </div>
        <button
          className="border border-gray-300 px-4 py-1 rounded-lg"
          onClick={next}
        >
          Done reading
        </button>
